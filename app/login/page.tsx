...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (destination === "/login") {
      setLoading(false);
      await supabase.auth.signOut();
      alert(`Unknown user role: ${getRoleDisplayName(profile.role)}`);
      return;
    }
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#080808] text-white">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -left-32 -top-32 h-[500px] w-[500px] rounded-full bg-yellow-400/[0.06] blur-[120px]" />
        <div className="absolute -right-40 top-1/2 h-[400px] w-[400px] rounded-full bg-yellow-400/[0.04] blur-[100px]" />
      ...
      <header className="fu relative z-10 border-b border-white/[0.06] bg-black/40 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <div>
            <p className="shimmer-text text-2xl font-black tracking-tight">
              FXA FITNESS
            </p>
        ...
        <div className="fu fu1 mb-10 grid items-start gap-10 lg:grid-cols-2">
          <div className="flex flex-col justify-center pt-4">
            ...
            <p className="mt-6 max-w-md text-base leading-7 text-gray-400">
              Manage sessions, track your package, scan QR codes, and stay on
              top of your fitness journey — all in one place.
            </p>
            ...
            <div className="mt-8 rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
              <p className="font-serif text-3xl leading-none text-yellow-400/60">
                &quot;
              </p>
              <p className="mt-1 text-sm italic leading-6 text-gray-300">
            ...
            >
              <div className="mb-6 text-center">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Admin · Manager · Trainer · Nutrition Coach
                </p>
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm text-white outline-none transition placeholder:text-gray-600 focus:border-yellow-400/60 focus:ring-1 focus:ring-yellow-400/20"
                />
              </div>
